            ...
            <div class="pop-up-wrap">
                ...
                <div class="subcription">
                    ...
                    <div class="sub-content">
                        ...
                        <a href="control/forms/forms_retiros_especial.php?id_modal=<?php echo $id;?>" class="subs-send">Pedido con retiro</a>
                        <a href="control/forms/forms_envios_especial.php?id_modal=<?php echo $id;?>" class="subs-send">Pedido con envio</a>
                    </div>
                    <div class="line"></div>
                </div>
            </div>
