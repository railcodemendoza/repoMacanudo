...
<div class="container">
    ...
    <div class="col-sm-12 pt-3">
        <h1>Modificar seccion galeria</h1>
        <form method="POST" action="actions/editar_galeria.php?id=<?php echo $id; ?>" enctype="multipart/form-data">

            <label class="pt-3 pb-2" for="img">Imagen galeria:</label>
