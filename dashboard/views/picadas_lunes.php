                         ...
                         <td>
                             <div class="btn-group">
                                 ...
                                 <a class="btn btn-danger" title="Eliminar"
                                     href="../actions/delete_pedidos.php?id=<?php echo $id;?>&dia=lunes"
         ...
         <div class="row">
             ...
             <div class="col-sm-3 mx-auto">
                 <form action="../actions/envio_mail_flete.php" method="POST">
                     <button type="submit" id="envio_lunes" name="envio_lunes" value="Export to excel"
