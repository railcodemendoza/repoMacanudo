         ...
         <div class="card-body card-block">
             ...
             <table id="bootstrap-data-table reponsive" class="table table-striped table-bordered">
                 <thead style="text-align: center;">
                    ...
                    $query = "SELECT * FROM `general` WHERE `delivery_date` <= (DATE_ADD(CURDATE(), INTERVAL 6 DAY)) AND delivery_date >= CURDATE() AND WEEKDAY(`delivery_date`) = 3"  ;
                         ...
                         <td>
                             <div class="btn-group">
                                             ...
                                             <div class="modal-body">
                                                 <div class="card border border-secondary">
                                                     <div class="card-body">
                                                         ...
                                                         <form
                                                             action="../actions/cambiar_status.php?id=<?php echo $id;?>&dia=jueves"
                                                             method="POST">
                                                             <div class="row">
                                                                 <div class="col-sm-2"></div>
                                                                 <div class="col-sm-8">
                                 ...
                                 <a class="btn btn-danger" title="Eliminar"
                                     href="../actions/delete_pedidos.php?id=<?php echo $id;?>&dia=jueves"
         ...
         <div class="row">
             ...
             <div class="col-sm-3 mx-auto">
                 <form action="../actions/envio_mail_flete.php" method="POST">
                     <button type="submit" id="envio_jueves" name="envio_jueves" value="Export to excel"
