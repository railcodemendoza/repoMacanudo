         ...
         <div class="card-body card-block">
             ...
             <table id="bootstrap-data-table responsive" class="table table-striped table-bordered">
                 <thead style="text-align: center;">
                     ...
                     <tr style="background-color: #F3B868;">
                         <td>##</td>
                         <td>Hoy</td>
                         <td>Matices del Vino</td>
                         <td>Picada Fellini (Clásica)</td>
                         <td>4</td>
                         <td>MDF</td>
                         <td>--</td>
                         <td>--</td>
                    ...
                    $query = "SELECT * FROM `general` WHERE `delivery_date` <= (DATE_ADD(CURDATE(), INTERVAL 6 DAY)) AND delivery_date >= CURDATE() AND WEEKDAY(`delivery_date`) = 5"  ;
                         ...
                         <td>
                             <div class="btn-group">
                                             ...
                                             <div class="modal-body">
                                                 <div class="card border border-secondary">
                                                     <div class="card-body">
                                                         ...
                                                         <form
                                                             action="../actions/cambiar_status.php?id=<?php echo $id;?>&dia=sabados"
                                                             method="POST">
                                                             <div class="row">
                                                                 <div class="col-sm-2"></div>
                                                                 <div class="col-sm-8">
                                 ...
                                 <a class="btn btn-danger" title="Eliminar"
                                     href="../actions/delete_pedidos.php?id=<?php echo $id;?>&dia=sabados"
         ...
         <<div class="row">
             ...
             <div class="col-sm-3 mx-auto">
                 <form action="../actions/envio_mail_flete.php" method="POST">
                     <button type="submit" id="envio_sabado" name="envio_sabado" value="Export to excel"
