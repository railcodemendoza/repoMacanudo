...
<div class="container-fluid">
    <div  class="card">
        ...
        <div class="table-responsive dataTables_info" id="bootstrap-data-table_info" role="status" aria-live="polite"></div>
            <table id="bootstrap-data-table" class="table table-striped table-bordered responsive">
                ...
                <th>id</th>
                  ...
                  <?php
                    ...
                    $query = "SELECT * FROM `general` ORDER BY created_at DESC LIMIT 50" ;
                  ...
                  <td>
                    ...
                    <td><?php echo $add3;?></td>
                    <td><?php echo $add2;?></td>
                    <td><?php echo $payment_mode;?><br><p style="font-size: 5;"><?php echo $status_pago;?></p></td>
                            <td  style="text-align:center; width:15%;">
                              <div class="btn-group">
                                <!--======================|   VER   |======================-->
                                <a class="btn btn-primary" title="Ver Detalle" href="#" data-toggle="modal" data-target="#ver<?php echo $id;?>">
                                  <i class="fa fa-eye"></i>
                                </a>
                                <a class="btn btn-primary" href="#" title="cambiar Status"  data-toggle="modal" data-target="#cambiar_status<?php echo $id;?>" >
                                  <i class="fa fa-check"></i>
                                </a>
                                <a class="btn btn-primary" href="#"  data-toggle="modal" data-target="#editar_pedido<?php echo $id;?>">
                                  <i class="fa fa-pencil"></i>
                                </a>
                                <a class="btn btn-primary" target="_blank" href="https://api.whatsapp.com/send?phone=54<?php echo $cel_phone;?>&text=Hola,%20te%20escribo%20de%20Picadas%20Macanudas"title="Contactar">
                                  <i class="fa fa-user"></i>
                                </a>
                                <a class="btn btn-danger" title="Eliminar" href="../actions/delete_pedidos.php?id=<?php echo $id;?>&dia=principal" type="button" >
                                          ...
                                          <div class="card border">
                                            <div class="card-body">
                                              ...
                                              <div class="row">
                                                <div class="col-sm-2"></div>
                                                <div class="col-sm-8" > 
                                                  <h4 style="text-align: center;"><strong>Picada: </strong><?php echo $product . ' - ' . $add3 .' ( '. $add1 . ')';?></h4>
                                                </div>
                                              </div> 
                                              <div class="row">
                                                <div class="col-sm-2"></div>
                          ...
                          <!--====================== MODAL EDITAR ======================-->
                              <div class="modal fade" id="editar_pedido<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 style="text-align:center;"class="modal-title" id="scrollmodalLabel">Cambiar datos de la Picada <strong><?php echo $id;?></strong></h4>    
                                    </div>
                                    <div class="modal-body">
                                      <div class="card border">
                                        <div class="card-body">
                                          <form action="../actions/editar_pedido.php?id=<?php echo $id;?>&vista=principal_todas" method="POST">
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                              ...
                                              <div class="form-group col-sm-4 mx-auto">
                                                ...
                                                <input class="form-control" type="name" name="customer" value="<?php echo $customer;?>"> 
                                              </div>
                                              <div class="form-group col-sm-4 mx-auto">
                                                <label for="name" >Celular</label>
                                                <input class="form-control" type="phone" name="cel_phone" value="<?php echo $cel_phone;?>"> 
                                              </div>
                                              <div class="col-sm-2"></div>
                                            </div>
                                            <div class="form-row">
                                              ...
                                              <div class="form-group col-sm-4 mx-auto">
                                                ...
                                                <input class="form-control" type="name" name="cnee" value="<?php echo $cnee;?>"> 
                                              </div>
                                              <div class="form-group col-sm-4 mx-auto">
                                                <label for="name" >Celular</label>
                                                <input class="form-control" type="phone" name="cnee_cel_phone" value="<?php echo $cnee_cel_phone;?>"> 
                                              </div>
                                              <div class="col-sm-2"></div>
                                            </div>
                                            <div class="row-group col-sm-8 mx-auto">
                                              <label for="comentario">Dedicatoria</label>
                                              <textarea class="form-control"name="inscription"><?php echo $inscription;?></textarea>
                                            </div>
                                            <div class="form-row">
                                              <div class="col-sm-2"></div>
                                              <div class="form-group col-sm-4 mx-auto">
                                                <label for="name" >Fecha</label>
                                                <input class="form-control" type="date" name="delivery_date" value="<?php echo $delivery_date;?>"> 
                                              </div>
                                              <div class="form-group col-sm-4 mx-auto">
                                                <label for="name" >Horario</label>
                                                <select name="schedule_available[]" class="form-control">
                                                <option value="<?php echo $schedule_available; ?>"><?php echo $schedule_available; ?></option>
                                                  <option value="de 10 a 13">Con Retiro - 10 a 13</option>
                                                  <option value="de 17 a 20">Con Retiro - 17 a 20</option>
                                                  <option value="de 10:30 - 13:30">Con Envio - 10:30 - 13:30</option>
                                                  <option value="de 14:00 - 17:00">Con Envio - 14:00 - 17:00</option>
                                                  <option value="de 18:00 - 20:00">Con Envio - 18:00 - 20:00</option>
                                                </select>
                                              </div>
                                              <div class="col-sm-2"></div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                              <label style="color:white" class="col-sm-8 control-label" >Tabla:</label>
                                              <div class="col-sm-8 mx-auto">
                                                <select name="product[]" class="form-control form-control" require>
                                            ...
                                            <div class="form-group">
                                              <label style="color:white" class="col-sm-8 control-label" >Tipo:</label>
                                              <div class="col-sm-8 mx-auto">
                                              <select name="add3[]" required class="form-control form-control" >
                                                    <option value="<?php echo $add3; ?>"><?php echo $add3; ?></option>     
                                                        <?php
                                            ...
                                            <div class="form-group">
                                              <label style="color:white" class="col-sm-8 control-label" >Comensales:</label>
                                              <div class="col-sm-8 mx-auto">
                                                <select name="add1[]" id="selectSm" required class="form-control form-control">
                                            ...
                                            <div class="form-group col-sm-8 mx-auto">
                                              ...
                                              <input type="number" value="<?php echo $in_ars; ?>" name="in_ars" class="form-control" >
                                            </div>
                                            <div class="form-group col-sm-8 mx-auto">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="card border border-secondary">
                                  ...
                                  <form action="../actions/cambiar_status.php?id=<?php echo $id;?>&dia=principal_todas" method="POST">
                                    <div class="row">
                                      <div class="col-sm-2"></div>
                                      <div class="col-sm-8">
