            ...
            <table id="bootstrap-data-table responsive" class="table table-striped table-bordered">
                <thead style="text-align: center;">
                  ...
                  <?php
                    ...
                    $query = "SELECT * FROM `general` WHERE `delivery_date` >= (DATE_ADD(CURDATE(), INTERVAL 7 DAY))" ;
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="card border border-secondary">
                                  ...
                                  <form action="../actions/cambiar_status.php?id=<?php echo $id;?>&dia=futuro" method="POST">
                                    <div class="row">
                                      <div class="col-sm-2"></div>
                                      <div class="col-sm-8">
                        ...
                        <!--Final Modal View CNTR-->   
                        <a class="btn btn-primary" href="#" type="button"  data-toggle="modal" data-target="#editar_pedido<?php echo $id;?>"><i class="fa fa-pencil"></i></a>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="card border">
                                  <div class="card-body">
                                    <form action="../actions/editar_pedido.php?id=<?php echo $id;?>&vista=futuro" method="POST">
                                      <div class="form-row">
                                      ...
                                      <div class="form-group col-sm-8 mx-auto">
                                          <label for="name" >Agregado</label>
                                          <select name="add2[]" class="form-control">
                                            <option value="<?php echo $add2; ?>"><?php echo $add2; ?></option>
                                              <?php
