...
<div class="container-fluid">
    <div  class="card">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="card border">
                                    <div class="card-body">
                                      <form action="../actions/agregar_add4.php?id=<?php echo $id;?>&vista=chipa" method="POST">
                                        <div class="row">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="card border">
                                    <div class="card-body">
                                      <form action="../actions/editar_add4.php?id=<?php echo $id;?>&vista=chipa" method="POST">
                                        <div class="row">
                                          <div class="col-sm-5 mx-auto">
                                            <div class="form-group">
        ...
        <form action="../report/report_chipa.php" method="POST">
