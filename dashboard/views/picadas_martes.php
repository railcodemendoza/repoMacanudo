         ...
         <div class="card-body card-block">
             ...
             <table id="bootstrap-data-table responsive" class="table table-striped table-bordered">
                 <thead style="text-align: center;">
                    ...
                    $query = "SELECT * FROM `general` WHERE `delivery_date` <= (DATE_ADD(CURDATE(), INTERVAL 6 DAY)) AND delivery_date >= CURDATE() AND WEEKDAY(`delivery_date`) = 1"  ;
                                             ...
                                             <div class="modal-body">
                                                 <div class="card border border-secondary">
                                                     <div class="card-body">
                                                         ...
                                                         <form
                                                             action="../actions/cambiar_status.php?id=<?php echo $id;?>&dia=martes"
                                                             method="POST">
                                                             <div class="row">
                                                                 <div class="col-sm-2"></div>
                                                                 <div class="col-sm-8">
                                                  ...
                                                  $mysqli = new mysqli('193.203.175.53', 'u101685278_labmac', 'Rail2021', 'u101685278_labmac'); 
         ...
         <div class="row">
             ...
             <div class="col-sm-3 mx-auto">
                 <form action="../actions/envio_mail_flete.php" method="POST">
                     <button type="submit" id="envio_martes" name="envio_martes" value="Export to excel"
