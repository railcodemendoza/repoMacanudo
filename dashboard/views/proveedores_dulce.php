...
<div class="container-fluid">
    <div  class="card">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="card border">
                                    <div class="card-body">
                                      <form action="../actions/agregar_add3.php?id=<?php echo $id;?>&vista=dulce" method="POST">
                                        <div class="row">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="card border">
                                    <div class="card-body">
                                      <form action="../actions/editar_add3.php?id=<?php echo $id;?>&vista=dulce" method="POST">
                                        <div class="row">
                                          <div class="col-sm-5 mx-auto">
                                            <div class="form-group">
        ...
        <form action="../report/report_dulce.php" method="POST">
