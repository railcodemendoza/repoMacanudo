    ...
    <table id="bootstrap-data-table responsive" class="table table-striped table-bordered">
        <thead style="text-align: center;">
            ...
            <?php
                    ...
                    $query = "SELECT * FROM `general` ORDER BY created_at DESC LIMIT 25" ;
                ...
                <td style="text-align:center; width:15%;">
                    <div class="btn-group">
                        ...
                        <a class="btn btn-primary" title="Ver Detalle" href="#" data-toggle="modal"
                            data-target="#ver<?php echo $id;?>">
                            <i class="fa fa-eye"></i>
                        </a>
                        <a class="btn btn-primary" href="#" title="cambiar Status" data-toggle="modal"
                            data-target="#cambiar_status<?php echo $id;?>">
                            <i class="fa fa-check"></i>
                        </a>
                        <a class="btn btn-primary" href="#" data-toggle="modal"
                            data-target="#editar_pedido<?php echo $id;?>">
                        ...
                        <a class="btn btn-danger" title="Eliminar"
                            href="../actions/delete_pedidos.php?id=<?php echo $id;?>&dia=principal" type="button">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">Detalles de
                                        Picada para <strong><?php echo $customer;?></strong></h4>
                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <h4 style="text-align:center;"> <strong> Nombre: </strong>
                                                        <?php echo $customer .' ('.$cel_phone . ') ' ?> </h4>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-2"></div>
                                                <div class="col-sm-8">
                                                    <h4 style="text-align:center;"> <strong> Receptor: </strong>
                                                        <?php echo $cnee .' ('.$cnee_cel_phone . ') ' ?> </h4>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-2"></div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <h4 style="text-align: center;"> <strong> Horario: </strong>
                                                        <?php echo $schedule_available ; ?> </h4>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-2"></div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <h4 style="text-align: center;"><strong>Observaciones:</strong>
                                                        <?php echo $observacion_interna;?></h4>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-2"></div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">Cambiar
                                        datos de la Picada <strong><?php echo $id;?></strong></h4>
                                </div>
                                <div class="modal-body">
                                    <div class="card border">
                                        <div class="card-body">
                                            <form
                                                action="../actions/editar_pedido.php?id=<?php echo $id;?>&vista=principal"
                                                method="POST">
                                                <div class="form-row">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-sm-4 mx-auto">
                                                        ...
                                                        <select name="schedule_available[]" class="form-control">
                                                            <option value="<?php echo $schedule_available; ?>">
                                                            ...
                                                            <option value="de 10:30 - 13:30">Con Envio - 10:30 - 13:30
                                                            </option>
                                                            <option value="de 14:00 - 17:00">Con Envio - 14:00 - 17:00
                                                            </option>
                                                            <option value="de 18:00 - 20:00">Con Envio - 18:00 - 20:00
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-2"></div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 mx-auto">
                                                        <select name="add3[]" required
                                                            ...
                                                            <option value="<?php echo $add3; ?>"><?php echo $add3; ?>
                                                            </option>
                                                            <?php
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 mx-auto">
                                                        <select name="add1[]" id="selectSm" required
                                                            class="form-control form-control">
                                                            <option value="<?php echo $add1; ?>"><?php echo $add1; ?>
                                                            </option>
                                                ...
                                                <div class="form-group col-sm-8 mx-auto">
                                                    ...
                                                    <input type="number" value="<?php echo $in_ars; ?>" name="in_ars"
                                                        class="form-control">
                                                </div>
                                                <div class="form-group col-sm-8 mx-auto">
                    ...
                    <!--======================|  CAMBIAR STATUS  |======================-->
                    <!--Modal asigned CNTR-->
                    <div class="modal fade" id="cambiar_status<?php echo $id;?>" tabindex="-1" role="dialog"
                        aria-labelledby="scrollmodalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">Cambiar
                                        estado a Picada <strong><?php echo $id;?></strong></h4>
                                </div>
                                <div class="modal-body">
                                    <div class="card border border-secondary">
                                        <div class="card-body">
                                            ...
                                            <form
                                                action="../actions/cambiar_status.php?id=<?php echo $id;?>&dia=principal"
                                                method="POST">
                                                <div class="row">
                                                    <div class="col-sm-2"></div>
                                                    <div class="col-sm-8">
