 ...
 <div class="container-fluid">
     <div class="card">
         ...
         <div class="card-body card-block">
             <div class="dataTables_info responsive" id="bootstrap-data-table_info" role="status" aria-live="polite">
             </div>
             <table id="bootstrap-data-table" class="table table-striped table-bordered">
                 <thead style="text-align: center;">
                     ...
                     <?php                   
                    $query = "SELECT * FROM `general` WHERE `delivery_date` <= (DATE_ADD(CURDATE(), INTERVAL 6 DAY)) AND delivery_date >= CURDATE() AND WEEKDAY(`delivery_date`) = 4"  ;
                         ...
                         <td>
                             <div class="btn-group">
                                             ...
                                             <div class="modal-body">
                                                 <div class="card border border-secondary">
                                                     <div class="card-body">
                                                         ...
                                                         <form
                                                             action="../actions/cambiar_status.php?id=<?php echo $id;?>&dia=viernes"
                                                             method="POST">
                                                             <div class="row">
                                                                 <div class="col-sm-2"></div>
                                                                 <div class="col-sm-8">
                                 ...
                                 <a class="btn btn-danger" title="Eliminar"
                                     href="../actions/delete_pedidos.php?id=<?php echo $id;?>&dia=viernes"
         ...
         <div class="row">
             ...
             <div class="col-sm-3 mx-auto">
                 <form action="../actions/envio_mail_flete.php" method="POST">
                     <button type="submit" id="envio_viernes" name="envio_viernes" value="Export to excel"
