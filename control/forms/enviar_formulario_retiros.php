...
// SELECCION DE LOS AGREGADOS NOMBRE Y PRECIO 

if  (isset($_POST['enviar_retiros'])) { 
  ...
  // ============== Agregados: 
    ...
    $query_precioadd = "SELECT SUM(in_ars) FROM `add2` WHERE `title` IN ($agregados)";
    $result_precioadd = mysqli_query($conn, $query_precioadd);
  
    if (mysqli_num_rows($result_precioadd) == 1) {
      $row = mysqli_fetch_array($result_precioadd);

      $precioadd = $row['SUM(in_ars)'];
    }
  ...
  $pre_total = $total_picada + $precioadd + $total_duela;
  $costo = $costo_picada + $costoadd + $costo_duela;
                         ...
                         <div class="card">
                             ...
                             <div class="card-body">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-sm-2">
                                         <h4 style="text-align: right;">Nombre:</h4>
                                     </div>
                                     <div class="col-sm-4"><?php echo $customer .' ('.$cel_phone . ') ' ?></div>
                            ...
                            <!--Muestra el total y en total con descuento-->
                             ...
                             <form action="../forms/confirmacion.php" method="POST">
                                 ...
                                 <div class="col-sm-4 mx-auto" style="text-align: center;"><button type="submit"
                                         name="confirmar_retiro" id="confirmar_retiro"
