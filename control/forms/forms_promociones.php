                 ...
                 <div class="col-lg-12">
                     <section class="panel <?php echo $padding;?>">
                         ...
                         <header class="panel-heading">
                             <h2 style="color:white; text-align:center;">Promocion día de la Madre</h2>

                             <div class="card col-sm-6 mx-auto mt-2">
                                 <p class="pt-5" style="text-align: center;">Tabla Fellini (Clásica - MDF) para que
                                     piquen 4</p>
                                 <p style="text-align: center;">Cerveza artesanal de litro</p>
                                 <p style="text-align: center;">Mix de chocolate (250gr)</p>
                                 <p style="text-align: center;">Envío</p>
                                 <hr style="width: 70%; margin-left:15%">
                                 <h3 style="text-align:center; color:#ffb03b; font-size: 3rem;">$ 1800,00</h3>
                         ...
                         <div style="text-align:center;" class="panel-body">
                             <form action="../forms/confirmacion_´promo.php" class="form-horizontal " method="POST">
                                 <div class="row">
                                     ...
                                     <div class="col-sm-5">
                                         ...
                                         <div class="form-group">
                                             <label style="color:white;" class="col-sm-6 control-label">Celular de quién
                                                 recibe</label>
                                             <div class="col-sm-10 mx-auto">
                                                 <input type="phone" name="cnee_cel_phone" minlength="10" maxlength="15"
                                                     placeholder="2613569823" class="form-control" require>
                                             </div>
                                         </div>
                                     </div>
                                 </div>
                                     ...
                                     <div class="col-sm-5">
                                         <div class="form-group">
                                             <label style="color:white;" class="col-sm-4 control-label">Fecha de
                                                 Entrega:</label>
                                             <div class="col-sm-10 mx-auto">
                                                 <input name="delivery_date" type="date" class="form-control" require>
                                             </div>
                                         </div>
                                     </div>
                                     <div class="col-sm-5">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-10 mx-auto">
                                                 ...
                                                 <small style="color:white; text-shadow: black 0.1em 0.1em 0.2em;"
                                                     class="help-block">por favor informar piso y departamento.</small>
                                             </div>
                                         </div>
                                     </div>
                                     <div class="col-sm-5">
                                 ...
                                 <!-- div class="row">
                       <div class="col-sm-4"></div>
                       <div class="col-sm-4"><h3 style="text-align: center; color:#ffb03b;">Armado de Pedido</h3></div>
                       <div class="col-sm-4"></div>
                      </div>
                      <br>
                      <div class="form-group">
                          <label style="color:white" class="col-sm-5 control-label" required>Tabla:</label>
                          <div class="col-sm-5 mx-auto">
                            <select name="product[]" class="form-control form-control" >
                          ...
                          <div class="col-sm-5 mx-auto">
                          <select name="type[]" require class="form-control form-control" >
                          ...
                          <br>
                          <div class="form-group">
                          <label style="color:white" class="col-sm-5 control-label" required>Comensales:</label>
                          <div class="col-sm-5 mx-auto">
                          <select name="comensales[]" id="selectSm" class="form-control form-control">
                            ...
                            <div class="card col-sm-5 mx-auto">
                              ...
                              <div class="card-body">
                                <div class="form-check">
                                  <div class="checkbox">
                                    <?php
                                      ...
                                      ?>
                                        ...
                                        <li style="list-style: none;"><input type="checkbox" name="agregado[]" value="<?php echo $title;?>" class="form-check-input">
                                        <?php echo $title;}*/?></li>
                                  </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                     <label style="color:white;" class="col-sm-3 control-label" require>Cerveza</label>
                                     <div class="col-sm-5 mx-auto">
                                         <select name="cerveza[]" required id="selectSm"
                                             class="form-control form-control">
                                             <option value="">-. elegir cerveza.-</option>
                                             <option value="Cerveza Cream">Cerveza Cream</option>
                                             <option value="Cerveza Golden">Cerveza Golden</option>
                                             <option value="Cerveza Kolsh">Cerveza Kolsh</option>
                                             <option value="Cerveza Porter">Cerveza Porter</option>
                                             <option value="Cerveza IPA">Cerveza IPA</option>
                                             <option value="Cerveza Scotish Ale">Cerveza Scotish Ale</option>

                                         </select>
                                     </div>
                                 </div>
                                 <div class="form-group">
                                     <label style="color:white;" class="col-sm-3 control-label" require>Forma de
                                         Pago</label>
                                     <div class="col-sm-5 mx-auto">
                                 ...
                                 <div class="col-sm-4 mx-auto" style="text-align: center;"><button type="submit"
                                         name="confirmar_promocion" id="enviar_envios"
                                         style="padding-left: 20%;padding-right: 20%;"
                                         class="btn btn-warning">Pedir</button></div>
                             </form>
                         </div>
                     </section>
                 </div>
