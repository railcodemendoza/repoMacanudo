                ...
                <div class="col-lg-12">
                    <section class="panel <?php echo $padding;?>">
                        ...
                        <div style="text-align:center;" class="panel-body">
                            <form action="../forms/enviar_formulario_retiros.php" class="form-horizontal "
                                method="POST">
                                <div class="row">
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                      ...
                                      ?>
                                        ...
                                        <br>
                                        <div class="form-group">
                                            <label style="color:white" class="col-sm-5 control-label"
                                                require>Comensales:</label>
                                            <div class="col-sm-5 mx-auto">
                                                <select name="comensales[]" id="selectSm"
                                      ...
                                      ?>
                                        ...
                                        ?>
                                                        ...
                                                        <button type="submit" name="enviar_retiros" id="enviar_retiros"
                                                            class="btn btn-warning col-sm-2 mx-auto">Pedir</button>
                                                    </div>
                            </form>
                        </div>
                    </section>
